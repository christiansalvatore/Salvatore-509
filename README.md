...
The current configuration of the database (20-fold nested cross-validation) was first used in a paper by Salvatore et al. ([Magnetic resonance imaging biomarkers for the early diagnosis of Alzheimer's disease: a machine learning approach. Frontiers in neuroscience, 2015](http://journal.frontiersin.org/article/10.3389/fnins.2015.00307/full)).
